...
# web application at http://Inilo1999.pythonanywhere.com/
...
#import sys
#
#path = '/home/Inilo1999/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/Inilo1999/mysite/mysite/settings.py'
## and your manage.py is is at '/home/Inilo1999/mysite/manage.py'
#path = '/home/Inilo1999/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
import sys
#
## The "/home/Inilo1999" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/Inilo1999/myproject"
path = '/home/Inilo1999/ProyectoPred'
if path not in sys.path:
    sys.path.append(path)
#
from api_preciocasas import app as application  # noqa
#
